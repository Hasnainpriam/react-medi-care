...
The pursuit of excellence in all these areas is the result of our willingness, commitment, dedication and strong moral determination to provide the highest quality of care.</p>
  ...
  <tbody>
    ...
    <tr>
      ...
      <div className='d-flex justify-content-evenly align-items-center counter'>
        <div>
          <div  className='mb-2 myIcon'><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
  ...
  <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
        ...
        <div>
        <div className='mb-2 myIcon'><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-emoji-smile-fill" viewBox="0 0 16 16">
