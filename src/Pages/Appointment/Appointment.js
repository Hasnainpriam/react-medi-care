...
const Appointment = () => {
  ...
  return (
    <div className='container'>
                          <h1 className="text-dark display-4 mt-3">Appointment</h1>
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-4">
                            <div className="mt-3">
                                ...
                                <img className='img-fluid' src={apt} alt="" />
                                        ...
                                        <div className="col-lg-6">
                                            <div className="form-group">
                                                <select onBlur={handledoc} className="form-control" id="exampleFormControlSelect2">
                                                    ...
                                                    <option>DR. Masudur Rahman Iqbal</option>
                                                    <option>Prof. Dr. Md. Ruhul Amin</option>
                                                    <option>Dr. Jannat Fatema</option>
                                                    <option>Dr. Mehejabin Morshed Mumu</option>
                                                    <option>Prof. Dr. Aslam Al mehdi</option>
                                                    <option>Dr. Sk. Nazrul Islam</option>
                                                    <option>Dr.Bidya Shina Mim</option>
                                                    <option>Dr. Shamim Reza</option>
                                                    <option>Dr. M. Sheheda Rashid</option>
                                                    <option>Dr. Roksana Begum</option>
                                                </select>
                                            </div>
                                        </div>
